$(document).ready(function () {
    ...
    $.ajax({
        ...
        success:function(resData){
            ...
            isFirstMenu=menulist.extend[0].children.length;
            showall(menulist.extend[0].children, showlist);
     ...
     function showall(menu_list, parent) {
        for (var menu in menu_list) {
            if (menu_list[menu].children.length > 0) {
                ...
                $(li).append("<a href=\""+menu_list[menu].url+"\" target=\"right\"><i class=\"fa fa-share\"></i> <span>"+menu_list[menu].text+"</span><i class=\"fa fa-angle-right pull-right\"></i></a>");
